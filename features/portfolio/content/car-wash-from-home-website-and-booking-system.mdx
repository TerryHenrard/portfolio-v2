...
<MediaPlayer
  ...
  src="https://f91vo3c1woiz7zgq.public.blob.vercel-storage.com/media/car-wash-from-home-website-and-booking-system-demo.mp4"
  title="Car Wash From Home Demo"
  aspectRatio="16/9"
  muted
  loop
  autoPlay
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
  <Card className="rounded-4xl corner-squircle">
    <CardHeader>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
  <div className="bg-primary/5 border border-primary/20 rounded-4xl corner-squircle p-6 text-center">
