...
<MediaPlayer
  ...
  src="https://f91vo3c1woiz7zgq.public.blob.vercel-storage.com/media/ai-powered-portfolio-demo.mp4"
...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
  <div className="corner-squircle rounded-4xl flex flex-col items-center justify-center p-6 bg-primary/5 border border-primary/10">
