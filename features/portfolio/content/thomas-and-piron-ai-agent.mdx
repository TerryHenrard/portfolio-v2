...
description: "Dive into the implementation of an AI agent for the customer service department of Thomas & Piron."
author: "Terry Henrard"
createdAt: "2025-11-24"
updatedAt: "2025-11-24"
tags: ["AI", "Architecture", "RAG", "Vector DB"]
category: "portfolio"
readingTimeMinutes: 5
coverImagePath: "/images/portfolio/thomas-and-piron-ai-agent/phone-mockup-1.png"
coverImageAlt: "Thomas & Piron AI Agent Phone Mockup"
---
...
![phone mockup 1](/images/portfolio/thomas-and-piron-ai-agent/phone-mockup-1.png "Hero image showcasing
the AI agent on a mobile device.")
...
![AI Agent Dashboard](/images/portfolio/thomas-and-piron-ai-agent/dashboard-mockup-1.png)
...
![System Architecture](/images/portfolio/thomas-and-piron-ai-agent/system-architecture.png)
...
<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-8">
  <card className="flex flex-col items-center justify-center p-6 bg-primary/5 border border-primary/10 rounded-4xl corner-squircle">
  ...
  <card className="flex flex-col items-center justify-center p-6 bg-primary/5 rounded-4xl border border-primary/10 corner-squircle">
...
![phone mockup 2](/images/portfolio/thomas-and-piron-ai-agent/phone-mockup-2.png)
...
Now, the customer service lead can actually take a lunch break. 🥪
